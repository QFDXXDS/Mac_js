...
@interface VidyoViewController : NSViewController<NSWindowDelegate, NSTableViewDataSource, NSTableViewDelegate>
{
@private
...
@property (assign) IBOutlet NSTextField *token;
@property (assign) IBOutlet NSTextField *displayName;
@property (assign) IBOutlet NSTextField *resourceId;
