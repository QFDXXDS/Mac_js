...
/*
{function:
	{name: LmiAndroidClearException}
	{parent: LmiAndroid}
	{description: Clears JNI exception on env.}
	{prototype: LmiBool LmiAndroidClearException(JNIEnv *env, LmiBool describe, const char *error_message)}
	{parameter: {name: env} {description: The current JNI environment.}}
	{parameter: {name: describe} {description: If LMI_BOOL is passed, full stack trace is created.}}
	{parameter: {name: error_message} {description: If not NULL, error_message is written.}}
	{return: If there was an exception to be cleared LMI_TRUE, otherwise LMI_FALSE.}
}
*/
LmiBool LmiAndroidClearException(JNIEnv *env, LmiBool describe, const char *error_message);
