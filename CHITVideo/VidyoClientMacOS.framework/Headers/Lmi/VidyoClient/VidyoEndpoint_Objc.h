...
@protocol VCRoomIRequestRoleChange
	...
	-(void) onRequestRoleChangeResult:(VCRoomSetPropertiesResult)result RequestId:(NSString*)requestId;
@end
...
@interface VCRoom : NSObject
{
	...
	-(BOOL) requestRoleChange:(VCRole)newRole Auth:(VCRoleAuthentication*)auth RoomIRequestRoleChange:(id<VCRoomIRequestRoleChange>)roomIRequestRoleChange RequestId:(NSString*)requestId;
...
@end
@interface VCRoleAuthentication : NSObject
{
}
