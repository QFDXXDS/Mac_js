...
typedef struct VidyoRoleAuthentication_ {
	LmiBool hasPassCode;
	LmiString passCode;
} VidyoRoleAuthentication;

/**
 {function visibility="private":
 	{name: VidyoRoleAuthenticationDestruct}
 	{parent: VidyoRoom}
 	{description: }
 	{prototype: void VidyoRoleAuthenticationDestruct(VidyoRoleAuthentication* auth)}
 	{parameter:
 		{name: auth}
 		{description:}
 	}
 ...
 */
void VidyoRoleAuthenticationDestruct(VidyoRoleAuthentication* auth);
...
/**
 {callback apigroup="simple":
 	...
 	{parent: VidyoRoom}
 	{description: }
 	{prototype: void (*VidyoRoomOnRequestRoleChangeResult)(const VidyoRoom* room, VidyoRoomSetPropertiesResult result, const LmiString* requestId)}
 	{parameter:
 		{name: room}
 		{description: Pointer to the VidyoRoom that triggered the callback. }
 	}
...
typedef void (*VidyoRoomOnRequestRoleChangeResult)(const VidyoRoom* room, VidyoRoomSetPropertiesResult result, const LmiString* requestId);
...
/**
 {function:
 	...
 	{parent: VidyoRoom}
 	{description: }
 	{prototype: LmiBool VidyoRoomRequestRoleChange(const VidyoRoom* room, VidyoRole newRole, const VidyoRoleAuthentication* auth, VidyoRoomOnRequestRoleChangeResult onRequestRoleChangeResult, const LmiString* requestId)}
...
*/
LmiBool VidyoRoomRequestRoleChange(const VidyoRoom* room, VidyoRole newRole, const VidyoRoleAuthentication* auth, VidyoRoomOnRequestRoleChangeResult onRequestRoleChangeResult, const LmiString* requestId);
